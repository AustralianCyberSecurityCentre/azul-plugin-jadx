...
class TestExecute(test_template.TestPlugin):
    ...
    def test_apk_calculator(self):
        ...
        self.assertReprEqual(
            ...
            {
                "class_methods": [
                    FV("HistoryDatabase::k"),
                    FV("HistoryDatabase_Impl::a"),
                    FV("HistoryDatabase_Impl::b"),
                    FV("HistoryDatabase_Impl::c"),
                    FV("HistoryDatabase_Impl::e"),
                    FV("HistoryDatabase_Impl::f"),
                    FV("HistoryDatabase_Impl::k"),
                ...
                "package_class_methods": [
                    ...
                    FV("com.sosauce.vanilla.domain.repository.HistoryDatabase::k"),
                    FV("com.sosauce.vanilla.domain.repository.HistoryDatabase_Impl::a"),
                    FV("com.sosauce.vanilla.domain.repository.HistoryDatabase_Impl::b"),
                    FV("com.sosauce.vanilla.domain.repository.HistoryDatabase_Impl::c"),
                    FV("com.sosauce.vanilla.domain.repository.HistoryDatabase_Impl::e"),
                    FV("com.sosauce.vanilla.domain.repository.HistoryDatabase_Impl::f"),
                    FV("com.sosauce.vanilla.domain.repository.HistoryDatabase_Impl::k"),
                ],
                "package_classes": [
                ...
                "package_methods": [
                    ...
                    FV("com.sosauce.vanilla.domain.repository::a"),
                    FV("com.sosauce.vanilla.domain.repository::b"),
                    FV("com.sosauce.vanilla.domain.repository::c"),
                    FV("com.sosauce.vanilla.domain.repository::e"),
                    FV("com.sosauce.vanilla.domain.repository::f"),
                    FV("com.sosauce.vanilla.domain.repository::k"),
        ...
        self.assertReprEqual(
            event.features,
            {
                ...
                "package_class_methods": [
                    ...
                    FV("net.tlfoxhuman.droidstress.MainActivity::q"),
                    FV("net.tlfoxhuman.droidstress.MainActivity::r"),
                ...
                "package_methods": [
                    ...
                    FV("net.tlfoxhuman.droidstress::q"),
